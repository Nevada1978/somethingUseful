...
# 给文档添加空行
# with open(currentFilePath_1, 'r', encoding='utf-8') as f:
#     lines = f.readlines()
#     with open(currentFilePath_1, 'w', encoding='utf-8') as f1:
#         for i,j in enumerate(lines): # i表示行号，j表示每行内容
#             f1.write('{}. {}'.format(i+1,j))
#     f1.close()
